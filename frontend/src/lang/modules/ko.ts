...
const message = {
    ...
    setting: {
        ...
        proxyHelper1: '설치 패키지 다운로드 및 앱 스토어 동기화 (Business Edition 전용)',
        proxyHelper2: '시스템 업데이트 및 업데이트 정보 확인 (Business Edition 전용)',
        proxyHelper4: 'Docker 이미지 pull 같은 네트워크 요청은 프록시 서버를 통해 처리됩니다 (Business Edition 전용)',
        proxyHelper3: '시스템 라이선스 인증 및 동기화',
        proxyHelper5: '시스템 스크립트 라이브러리 통합 다운로드 및 동기화 (Business Edition 기능)',
        proxyHelper6: '인증서 신청 (Business Edition 기능)',
        proxyType: '프록시 유형',
        proxyUrl: '프록시 주소',
        proxyPort: '프록시 포트',
    ...
    license: {
        ...
        quickUpdate: '빠른 업데이트',
        power: '권한 부여',
        unbindHelper: '연결 해제 후 모든 Business Edition 관련 설정이 초기화됩니다. 계속하시겠습니까?',
        importLicense: '라이센스',
        importHelper: '라이센스 파일을 여기에 클릭하거나 드래그하세요',
        technicalAdvice: '기술 상담',
        advice: '상담',
        levelUpPro: 'Business Edition으로 업그레이드',
        licenseSync: '라이센스 동기화',
        knowMorePro: '더 알아보기',
        closeAlert: '현재 페이지는 패널 설정에서 닫을 수 있습니다.',
        introduce: '기능 소개',
        waf: 'Business Edition으로 업그레이드하면 차단 맵, 로그, 차단 기록, 지역 차단, 사용자 정의 규칙, 사용자 정의 차단 페이지 등을 사용할 수 있습니다.',
        tamper: 'Business Edition으로 업그레이드하면 웹사이트를 무단 수정이나 변조로부터 보호할 수 있습니다.',
        setting: 'Business Edition으로 업그레이드하면 패널 로고, 환영 메시지 등 정보를 사용자 정의할 수 있습니다.',
        monitor:
            'Business Edition으로 업그레이드하면 웹사이트의 실시간 상태, 방문자 추세, 유입 경로, 요청 로그 등을 확인할 수 있습니다.',
        alert: 'Business Edition으로 업그레이드하면 SMS 알림을 받고 알림 로그를 확인할 수 있습니다.',
        node: 'Business Edition으로 업그레이드하면 1Panel에서 여러 Linux 서버를 관리할 수 있습니다.',
        nodeApp:
            'Business Edition으로 업그레이드하면 노드를 수동으로 전환하지 않고도 다중 노드 애플리케이션 버전을 일괄 업그레이드할 수 있습니다.',
        nodeDashboard:
            'Business Edition으로 업그레이드하면 다중 노드 애플리케이션, 웹사이트, 데이터베이스, 예약 작업을 중앙에서 관리할 수 있습니다.',
        fileExchange: 'Business Edition으로 업그레이드하면 여러 서버 간에 파일을 빠르게 전송할 수 있습니다.',
        app: 'Business Edition으로 업그레이드하면 모바일 앱에서 서비스 정보와 이상 모니터링을 확인할 수 있습니다.',
        cluster: 'Business Edition으로 업그레이드하면 MySQL/Postgres/Redis 기본-복제 클러스터를 관리할 수 있습니다.',
        'model-downloader':
            'Business Edition으로 업그레이드하면 HuggingFace, ModelScope 또는 호환 미러에서 로컬 모델 파일을 검색, 다운로드 및 관리하고 모델 디렉터리와 다운로드 작업을 통합 관리할 수 있습니다.',
        exceptionalHelper:
            '라이선스 동기화 검증이 비정상입니다. 수동으로 동기화해 Business Edition 기능이 정상적으로 동작하는지 확인하세요. 상세: ',
    ...
    xpack: {
        expiresTrialAlert:
            '친절한 알림: 귀하의 Business Edition 체험판이 {0}일 후 만료되며, 모든 Business Edition 기능에 더 이상 접근할 수 없습니다. 제때 갱신하거나 전체 버전으로 업그레이드하시기 바랍니다.',
        expiresAlert:
            '친절한 알림: 귀하의 Business Edition 라이선스가 {0}일 후 만료되며, 모든 Business Edition 기능에 더 이상 접근할 수 없습니다. 지속적인 사용을 위해 신속하게 갱신하시기 바랍니다.',
        menu: 'Business Edition',
        upage: 'AI 웹사이트 빌더',
        proAlert: '이 기능을 사용하려면 Business Edition으로 업그레이드하세요',
        app: {
            app: 'APP',
            title: '패널 별칭',
        ...
        node: {
            ...
            syncWithMaster:
                'Business Edition으로 업그레이드 후 모든 데이터가 기본적으로 동기화됩니다. 노드 관리에서 동기화 정책을 수동으로 조정할 수 있습니다.',
        ...
        customApp: {
            ...
            licenseHelper: 'Business Edition은 사용자 정의 애플리케이션 저장소 기능을 지원합니다',
