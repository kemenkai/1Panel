...
const message = {
    ...
    toolbox: {
        ...
        clam: {
            clam: 'ウイルススキャン',
            cron: 'スケジュールされたスキャン',
            cronHelper: 'ビジネス版は定期スキャンに対応しています',
            ...
            alertHelper: 'ビジネス版は定期スキャンと SMS アラートに対応しています',
    ...
    file: {
        ...
        aiSearchContainSub: 'サブディレクトリを含む',
    ...
    setting: {
        ...
        proxyHelper1: 'アプリストアからのインストールパッケージのダウンロードと同期（ビジネス版のみ）',
        proxyHelper2: 'システムアップデートと更新情報の取得（ビジネス版のみ）',
        proxyHelper4:
            'Docker イメージの取得などのネットワークリクエストはプロキシサーバー経由で処理されます（ビジネス版のみ）',
        proxyHelper5: 'システム系スクリプトライブラリの一括ダウンロードと同期（ビジネス版機能）',
        ...
        descriptionWindows: 'Windowsサーバーパネル',
        forum: '議論',
        doc2: 'ドキュメント',
    ...
    license: {
        ...
        power: '許可',
        unbindHelper:
            'すべてのビジネス版関連設定は、バインディングを解除した後にクリーニングされます。続けたいですか？',
        importLicense: 'ライセンス',
        importHelper: 'ここでライセンスファイルをクリックまたはドラッグしてください',
        technicalAdvice: '技術的な相談',
        advice: '相談',
        levelUpPro: 'ビジネス版 にアップグレード',
        licenseSync: 'ライセンス同期',
        knowMorePro: 'もっと詳しく知る',
        closeAlert: '現在のページはパネル設定で閉じることができます',
        introduce: '機能の紹介',
        waf: 'ビジネス版にアップグレードすると、インターセプトマップ、ログ、ブロック記録、地域ブロック、カスタムルール、カスタムブロックページなどを利用できます。',
        tamper: 'ビジネス版にアップグレードすると、Web サイトを不正な変更や改ざんから保護できます。',
        setting: 'ビジネス版にアップグレードすると、パネルロゴ、ウェルカムメッセージなどをカスタマイズできます。',
        monitor:
            'ビジネス版にアップグレードすると、Web サイトのリアルタイム状態、訪問者トレンド、流入元、リクエストログなどを確認できます。',
        alert: 'ビジネス版にアップグレードすると、SMS アラートの受信やアラートログの確認が可能になります。',
        app: 'ビジネス版にアップグレードすると、モバイルアプリでサービス情報や異常監視を確認できます。',
        node: 'ビジネス版 にアップグレードすると、1Panel で複数の Linux サーバーを管理できます。',
        nodeApp:
            'ビジネス版 にアップグレードすると、ノードを手動で切り替えずにマルチノードアプリのバージョンを一括アップグレードできます。',
        nodeDashboard:
            'ビジネス版 にアップグレードすると、マルチノードのアプリ、Web サイト、データベース、スケジュールタスクを一元管理できます。',
        fileExchange: 'ビジネス版 にアップグレードすると、複数サーバー間でファイルをすばやく転送できます。',
        cluster: 'ビジネス版 にアップグレードすると、MySQL/Postgres/Redis のプライマリ/レプリカ構成を管理できます。',
        'model-downloader':
            'ビジネス版にアップグレードすると、HuggingFace、ModelScope、または互換ミラーからローカルモデルファイルを検索、ダウンロード、管理できます。モデルディレクトリとダウンロードタスクを一元管理できます。',
    ...
    xpack: {
        ...
        alert: {
            ...
            alertConfigProHelper: 'ビジネス版では、WeCom、DingTalk、Feishu、SMS 通知も利用できます。',
        },
        theme: {
