...
const message = {
    ...
    file: {
        ...
        aiSearchContainSub: 'Включая подкаталоги',
    ...
    setting: {
        ...
        descriptionWindows: 'Панель управления Windows сервером',
        forum: 'Обсуждения',
        doc2: 'Документация',
    ...
    xpack: {
        expiresTrialAlert:
            'Дружеское напоминание: ваша пробная коммерческая версия истечет через {0} дней, и все функции коммерческой версии станут недоступны. Пожалуйста, своевременно продлите или обновите до полной версии.',
        expiresAlert:
            'Дружеское напоминание: ваша коммерческая лицензия истечет через {0} дней, и все функции коммерческой версии станут недоступны. Пожалуйста, продлите лицензию вовремя, чтобы обеспечить дальнейшее использование.',
        menu: 'Рro',
