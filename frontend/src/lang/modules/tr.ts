...
const message = {
    ...
    toolbox: {
        ...
        clam: {
            ...
            cronHelper: 'Business sürüm zamanlanmış taramayı destekler',
            ...
            alertHelper: 'Business sürüm zamanlanmış tarama ve SMS uyarılarını destekler',
    ...
    file: {
        ...
        aiSearchContainSub: 'Alt dizinleri dahil et',
    ...
    setting: {
        ...
        proxyHelper1: 'Uygulama mağazasından kurulum paketi indirme ve senkronizasyon (yalnızca Business sürüm)',
        proxyHelper2: 'Sistem güncellemeleri ve güncelleme bilgilerini alma (yalnızca Business sürüm)',
        proxyHelper3: 'Sistem lisansı doğrulama ve senkronizasyon',
        proxyHelper4: 'Docker imajı çekme gibi ağ istekleri vekil sunucu üzerinden yapılır (yalnızca Business sürüm)',
        proxyHelper5: 'Sistem komut dosyası kütüphaneleri için birleşik indirme ve senkronizasyon (Business özelliği)',
        proxyHelper6: 'Sertifika başvurusu (Business özelliği)',
        ...
        descriptionWindows: 'Windows Sunucu Paneli',
        forum: 'Tartışmalar',
        doc2: 'Dokümantasyon',
    ...
    license: {
        ...
        lostHelper:
            'Lisans yeniden deneme sınırına ulaştı. Business özelliklerinin düzgün çalışması için lütfen senkronizasyonu manuel olarak çalıştırın.',
        exceptionalHelper:
            'Lisans senkronizasyon doğrulaması başarısız oldu. Business özelliklerinin düzgün çalışması için lütfen senkronizasyonu manuel olarak çalıştırın. ayrıntı: ',
        ...
        waf: 'Business sürüme yükselterek engelleme haritası, günlükler, engelleme kayıtları, coğrafi konum engelleme, özel kurallar ve özel engelleme sayfaları gibi özellikleri açabilirsiniz.',
        tamper: 'Business sürüme yükselterek web sitelerini yetkisiz değişikliklere ve kurcalamaya karşı koruyabilirsiniz.',
        tamperHelper:
            'İşlem başarısız oldu, dosya veya klasörde kurcalama koruması etkin. Lütfen kontrol edin ve tekrar deneyin!',
        setting:
            'Business sürüme yükselterek panel logosunu, hoş geldiniz mesajını ve diğer bilgileri özelleştirebilirsiniz.',
        monitor:
            'Business sürüme yükselterek web sitesinin gerçek zamanlı durumunu, ziyaretçi eğilimlerini, kaynaklarını ve istek günlüklerini görüntüleyebilirsiniz.',
        alert: 'Business sürüme yükselterek SMS uyarıları alabilir, uyarı günlüklerini görüntüleyebilir ve kritik olayları takip edebilirsiniz.',
        node: 'Business Sürüme yükselterek 1Panel ile birden fazla Linux sunucusunu yönetebilirsiniz.',
        nodeApp:
            'Business Sürüme yükselterek düğümleri manuel değiştirmeden çok düğümlü uygulama sürümlerini toplu olarak yükseltebilirsiniz.',
        nodeDashboard:
            'Business Sürüme yükselterek çok düğümlü uygulamaları, web sitelerini, veritabanlarını ve zamanlanmış görevleri merkezi olarak yönetebilirsiniz.',
        fileExchange: 'Business Sürüme yükselterek birden fazla sunucu arasında dosyaları hızlıca aktarabilirsiniz.',
        app: 'Business sürüme yükselterek mobil uygulamada hizmet bilgilerini ve anormallik izlemeyi görüntüleyebilirsiniz.',
        cluster: 'Business Sürüme yükselterek MySQL/Postgres/Redis birincil-kopya kümelerini yönetebilirsiniz.',
        'model-downloader':
            'Business sürümüne yükselterek HuggingFace, ModelScope veya uyumlu aynalardan yerel model dosyalarını arayabilir, indirebilir ve yönetebilir; model dizinlerini ve indirme görevlerini merkezi olarak takip edebilirsiniz.',
    },
    clean: {
    ...
    xpack: {
        expiresTrialAlert:
            'Nazik hatırlatma: Business deneme sürümünüz {0} gün içinde sona erecek ve tüm Business özellikleri kullanılamaz hale gelecektir. Lütfen zamanında yenileyin veya tam sürüme yükseltin.',
        expiresAlert:
            'Nazik hatırlatma: Business lisansınız {0} gün içinde sona erecek ve tüm Business özellikleri kullanılamaz hale gelecektir. Lütfen devam eden kullanım için zamanında yenileyin.',
        menu: 'Business',
        upage: 'AI Web Sitesi Oluşturucu',
        proAlert: 'Bu özelliği kullanmak için Business’a yükseltin',
        app: {
            app: 'Uygulama',
            title: 'Panel Takma Adı',
        ...
        node: {
            ...
            syncWithMaster:
                'Business’a yükseltildikten sonra, tüm veriler varsayılan olarak senkronize edilir. Senkronizasyon politikaları düğüm yönetiminde manuel olarak ayarlanabilir.',
        ...
        customApp: {
            ...
            selectNode: 'Düğüm Seç',
            selectNodeError: 'Lütfen bir düğüm seçin',
            licenseHelper: 'Business sürümü, özel uygulama deposu özelliğini destekler',
        ...
        alert: {
            ...
            licenseHelper: 'Business sürüm ek uyarı kanallarını destekler',
            ...
            alertConfigProHelper: 'Business sürüm ayrıca WeCom, DingTalk, Feishu ve SMS bildirimlerini destekler.',
        },
        theme: {
