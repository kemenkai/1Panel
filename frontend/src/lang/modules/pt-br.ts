...
const message = {
    ...
    setting: {
        ...
        descriptionWindows: 'Painel de Servidor Windows',
        forum: 'Discussões',
        doc2: 'Documentação',
    ...
    xpack: {
        ...
        node: {
            ...
            communityHelper: 'Gerenciamento simples de nós da edição community: salve endereços de painéis para acesso rápido, verificação de status e edição.',
